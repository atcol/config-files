...
1. Red - Write a failing test that enforces new desired behavior. Run it, it should fail (or the code will not compile). Do not modify non-test code in the Red phase!
...
Always use British English spelling & grammar.
Second line: blank
